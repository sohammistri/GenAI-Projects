...
assistant_id = "asst_k30KxwPMfc1iXbqpNvU43ONk"
thread_id = "thread_bQ8qIjNLeGc9aaZoG3Wrcqxi"
...
def upload_to_openai(file_path):
    ...
    client.beta.assistants.files.create(assistant_id=assistant_id, file_id=file_obj.id)  
    return file_obj.id

file_uploaded = st.sidebar.file_uploader(
    "Upload a file to be queried on..", key="file_upload"
)
